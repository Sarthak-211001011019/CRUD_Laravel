    ...
    <div class="container">
        ...
        <form method="POST" action="{{url('/change_pass_logic')}}">
          ...
          <div class="form-group">
                ...
                <input type="text" readonly class="form-control" name="User_ID" value= "{{$user_id}}" required>
            </div>
         <div class="form-group">
                <label for="name">Current Password:</label>
                <input type="text" class="form-control" id="user_id" name="OldPassword" placeholder="Enter Current Password" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="pass" name="ConPassword" placeholder="Enter New Password Again" required>
            </div>
